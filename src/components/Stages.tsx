...
export const TransitionStage: React.FC = () => {
  ...
  return (
    <group ref={group}>
      <Torus args={[10, 0.05, 16, 100]} rotation={[Math.PI / 2, 0, 0]}>
        <meshStandardMaterial color="#10b981" transparent opacity={0.1} />
      </Torus>
      <Torus args={[8, 0.02, 16, 100]} rotation={[0, Math.PI / 2, 0]}>
  ...
  return (
    <group position={[0, -1, 0]}>
      ...
      <group ref={farmerRef} position={[-3, 0, 0]}>
        <Cylinder args={[0.4, 0.5, 1.5]} position={[0, 0.75, 0]}><meshStandardMaterial color="#228b22" /></Cylinder>
        <Sphere args={[0.3]} position={[0, 1.7, 0]}><meshStandardMaterial color="#ffdbac" /></Sphere>
      ...
      <group ref={artisanRef} position={[3, 0, 0]}>
        <Cylinder args={[0.4, 0.5, 1.5]} position={[0, 0.75, 0]}><meshStandardMaterial color="#8b0000" /></Cylinder>
        <Sphere args={[0.3]} position={[0, 1.7, 0]}><meshStandardMaterial color="#ffdbac" /></Sphere>
        <Cylinder ref={potRef} args={[0.2, 0.3, 0.4]} position={[-0.5, 1, 0]}><meshStandardMaterial color="#cd853f" /></Cylinder>
      </group>
    </group>
  );
};
...
export const DeptStoreStage: React.FC<{ active: boolean }> = ({ active }) => {
  ...
  return (
    <group position={[0, -1, 0]}>
      ...
      <Cylinder ref={gear1} args={[1.5, 1.5, 0.3]} position={[-5, 5, -3]} rotation={[Math.PI / 2, 0, 0]}><meshStandardMaterial color="#555" /></Cylinder>
      <Cylinder ref={gear2} args={[1, 1, 0.3]} position={[-3.2, 5.5, -3.1]} rotation={[Math.PI / 2, 0, 0]}><meshStandardMaterial color="#666" /></Cylinder>
      <group ref={customer} position={[0, 0, 4]}>
        <Cylinder args={[0.2, 0.2, 1.2]} position={[0, 0.6, 0]}><meshStandardMaterial color="#4f46e5" /></Cylinder>
        <Sphere args={[0.15]} position={[0, 1.3, 0]}><meshStandardMaterial color="#ffdbac" /></Sphere>
      </group>
    </group>
  );
};
    ...
    <group position={[0, -1, 0]}>
      ...
      <group ref={cart}>
        ...
        <group position={[-1, 0, 0]}>
           <Cylinder args={[0.2, 0.2, 1.4]} position={[0, 0.7, 0]}><meshStandardMaterial color="#334155" /></Cylinder>
           <Sphere args={[0.15]} position={[0, 1.5, 0]}><meshStandardMaterial color="#ffdbac" /></Sphere>
        </group>
      </group>
    </group>
  );
    ...
    <group position={[0, -1, 0]}>
      ...
      <group ref={particles} position={[-4, 0, 0]}>
        {Array.from({ length: 20 }).map((_, i) => (
          <Sphere key={i} args={[0.04]} position={[(Math.random()-0.5)*2, Math.random()*5, (Math.random()-0.5)*2]}>
      ...
      <group position={[4, 0, 0]}>
        <Cylinder args={[0.3, 0.3, 1.6]} position={[0, 0.8, 0]}><meshStandardMaterial color="#312e81" /></Cylinder>
        <Sphere args={[0.2]} position={[0, 1.8, 0]}><meshStandardMaterial color="#ffdbac" /></Sphere>
    ...
    <group position={[0, 0, 0]}>
      {type === 'wheel' && (
        <group ref={wheel}>
          ...
          <Sphere name="indicator" args={[0.3]} position={[0, 0, 4]}>
    ...
    <group>
      ...
      <group ref={particles}>
        {Array.from({ length: 100 }).map((_, i) => (
          <Sphere key={i} args={[0.05]} position={[(Math.random()-0.5)*15, (Math.random()-0.5)*15, (Math.random()-0.5)*15]}>
